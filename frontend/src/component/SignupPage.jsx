  ...
  return (
    <div className={classes.container}>
      ...
      <div class={classes.gridContainer}>
        ...
        <div className={`${classes.gridItem} input-group mb-3`}>
          <span class="input-group-text" id="6">
            High School percentage
          </span>
          <input type="text" class="form-control shadow-none " />
        </div>
        <div className={`${classes.gridItem} input-group mb-3`}>
          <span class="input-group-text" id="7">
            Intermediate percentage
          </span>
          <input type="text" class="form-control shadow-none " />
        </div>
        <div className={`${classes.gridItem} input-group mb-3`}>
          <span class="input-group-text" id="8">
            Year of Passout
          </span>
          <select
            class="form-control shadow-none"
        ...
        <div className={`${classes.gridItem} input-group mb-3`}>
          <span class="input-group-text" id="9">
            Gender
          </span>
          <select
            class="form-control shadow-none"
        ...
        <div className={`${classes.gridItem} input-group mb-3`}>
          <span class="input-group-text" id="10">
            Role
          </span>
          <select
            class="form-control shadow-none"
        ...
        <div class={`${classes.gridContainer} ${classes.Container2}`}>
          <div className={`${classes.gridItem} input-group mb-3`}>
            <input
              ...
              id="inputGroupFile02"
            />
            <span class="input-group-text" for="inputGroupFile02">
              Upload
            </span>
          </div>
        </div>
